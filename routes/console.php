...
Artisan::command('install', function (){
    ...
    */
    ...
    -- Records of devisi
    -- ----------------------------
    INSERT INTO `devisi` VALUES (1, NULL, '2017-05-17 02:57:26', '2017-12-04 08:09:14', 0, 'Head Office', NULL);
    ...
    INSERT INTO `menu` VALUES (70, '2021-07-07 13:27:16', NULL, NULL, 'role', 'Jabatan', 'fa fa-lock', 42, 4);
    ...
    CREATE TABLE `user`  (
      ...
      `last_online_datetime` datetime(0) NULL DEFAULT NULL,
