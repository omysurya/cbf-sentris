	...
	<div class="panel panel-default">
		...
		<div class="panel-body">
			...
			<div class="form-group">
				...
				<div class="col-sm-10">					
					<select id='id_devisi' name="id_devisi" required class="form-control">
						<option value="">** Pilih Devisi</option>
						@php $devisi = getData('devisi',NULL,'nama asc'); @endphp
						@foreach($devisi as $p)
							<option <?php echo $p->id==$row->id_devisi?"selected":""?> value="{{$p->id}}">{{$p->nama}}</option>
						@endforeach
					</select>					
				</div>
			</div>
