	...
	<div class="panel panel-default">
		...
		<div class="panel-body">
			...
			<div class="form-group">
				<label>Icon</label>
				<input type="text" name="icon" class="form-control" value="{{ old('icon')?:$row->icon }}" required >				
			</div>
			...
			<div class="form-group">
				...
				<input type="text" name="module_path" class="form-control" value="{{ old('module_path')?:$row->module_path }}" required >				
			</div>
