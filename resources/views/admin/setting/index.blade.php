...
<section class="content">
	...
	<div class="panel panel-default">
		...
		<div class="panel-body">
			...
			<div class="form-group">
				<label class="col-sm-2 control-label">Setting Apps</label>
				<div class="col-sm-3">
					<input type="file" name="banner" class="form-control" >
					<div class="help-block">
						@if(getSetting('banner'))
							<p><i class="fa fa-image"></i> <a href="{{asset(getSetting('banner'))}}" target="_blank">Banner</a></p>
						@else
                            Banner
                        @endif
					</div>
				...
				<div class="col-sm-3">
					...
					<div class="help-block">Version</div>
				</div>
				<div class="col-sm-3">
					...
					<div class="help-block">
						@if(getSetting('last_app_version_link'))
							<p>
								<i class="fa fa-angle-down"></i> <a href="{{asset(getSetting('last_app_version_link'))}}" target="_blank">Installer APK</a>
							</p>
                        @else
                            File APK
						@endif
			...
			<div class="form-group">
				...
				<div class="col-sm-10">
					<input type="text" name="app_service_title" class="form-control" value="{{ getSetting('app_service_title') }}" >
				</div>
			</div>
			<div class="form-group">
				<label class="col-sm-2 control-label">App Text</label>
				<div class="col-sm-10">
					<input type="text" name="app_service_text" class="form-control" value="{{ getSetting('app_service_text') }}" >
				</div>
			</div>
			<div class="form-group">
				<label class="col-sm-2 control-label">App Ping Interval <small>(Menit)</small></label>
				<div class="col-sm-2">
					<input type="text" name="app_service_ping" class="form-control" value="{{ getSetting('app_service_ping') }}" >
				</div>
			</div>
			<!-- <div class="form-group">
			...
			<div class="form-group">
				<label class="col-sm-2 control-label">Toleransi Online User (Menit)</label>
				<div class="col-sm-2">
					<input type="text" name="user_online" class="form-control" value="{{ getSetting('user_online') }}" >
				</div>
			</div>
			...
			<div class="form-group">
				...
				<div class="col-sm-2">
					<input type="number" name="max_visit_dokter_per_day" class="form-control" value="{{getSetting('max_visit_dokter_per_day')}}">
				</div>
			</div>
			...
			<div class="form-group">
				...
				<div class="col-sm-2">
					<input type="number" name="max_visit_outlet_per_day" class="form-control" value="{{getSetting('max_visit_outlet_per_day')}}">
				</div>
			</div>
			...
			<div class="form-group">
				<label class="col-sm-2 control-label">Ketentuan Cuti</label>
				<div class="col-sm-3">
					<input type="text" name="cuti_month_expired" class="form-control" value="{{getSetting('cuti_month_expired')}}">
					<div class="help-block">Bulan Expire</div>
				</div>
				<div class="col-sm-3">
					<input type="text" name="cuti_percent_saldo" class="form-control" value="{{getSetting('cuti_percent_saldo')}}">
					<div class="help-block">Batas Sisa Cuti (Persen)</div>
				</div>
			</div>
			<hr>
